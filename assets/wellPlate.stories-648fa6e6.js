import{W as l,j as r,a as b}from"./WellPlate-d2031630.js";import"./index-f80c8c95.js";const h={title:"Example/WellPlate",component:l,args:{rows:8,columns:12}};function n(e){return r(l,{...e})}function o(){return r(l,{rows:8,columns:12,wellSize:30,wellStyle:()=>({fontSize:"x-small"})})}function t(){return r(l,{rows:8,columns:12,wellSize:60})}function s(){return r(l,{rows:8,columns:12,wellSize:50,headerText:({position:e})=>{if(e.column>5)return e.column;if(e.column>3)return null;if(e.column>2)return"";if(e.row>6)return e.row;if(e.row===4)return null;if(e.row===3)return""},renderText:({index:e})=>e===0?null:e===1?"":e===2?null:b("div",{style:{fontSize:12},children:[r("div",{children:"test"}),r("div",{children:e})]}),wellStyle:({label:e,wellPlate:a})=>{const u=Math.round(a.getPosition(e,"index")/(a.rows*a.columns)*120+135);return{backgroundColor:`rgb(${u}, ${u}, ${u})`,borderColor:"green",borderWidth:2}}})}var i,c,m;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`function Control(props: IWellPlateProps) {
...
//# sourceMappingURL=wellPlate.stories-648fa6e6.js.map
